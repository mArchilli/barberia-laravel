                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="border border-white/10 bg-white/5 backdrop-blur-sm p-6">
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <span className="px-3 py-1 bg-yellow-500/20 border border-yellow-500/30 text-yellow-400 text-xs font-semibold">
                                    ADMIN
                                </span>
                            </div>
                        ...
                        {barbers.length > 0 ? (
                            barbers.map((barber) => (
                                <div key={barber.id} className="border border-white/10 bg-white/5 backdrop-blur-sm p-6">
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                                        ...
                                        <span className="px-3 py-1 bg-white/10 border border-white/20 text-white text-xs font-semibold">
                                            ACTIVO
                                        </span>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-2 bg-red-500/20 text-red-400 border border-red-500/30 hover:bg-red-500/30 transition text-sm font-semibold"
                                    >
                                        Desvincular
                                    </button>
                                </div>
                            ...
                            <div className="col-span-full border border-white/10 bg-white/5 backdrop-blur-sm p-12 text-center">
